    ...
    <div className="flex flex-col bg-[#141414] w-md min-h-[550px]">
      ...
      <header className="text-white text-center py-2 flex justify-between items-center px-4 fixed w-full">
        ...
        <nav className="flex space-x-2">
          <button
            ...
            className="p-2 rounded-full border border-emerald-400 transition-all duration-200"
          >
            <PinIcon
              isActive={activeStates.pin}
              className="transition-all duration-200 text-emerald-400"
            />
          </button>
          <button
          ...
          <button className="p-2 rounded-full border border-emerald-400 bg-transparent transition-all duration-200">
            <ExportIcon className="transition-all duration-200 text-emerald-400" />
          </button>
        </nav>
      </header>
      {/* Main Content */}
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8">
        ...
        <button
          ...
          className="px-4 py-1.5 flex items-center font-semibold justify-between bg-emerald-300 text-black hover:bg-transparent hover:text-emerald-300 border border-emerald-300 transition-colors rounded-full"
        >
          New Note
          <svg
            xmlns="http://www.w3.org/2000/svg"
